...
public class Quiz extends AppCompatActivity {
    ...
    public void empezarJuego() {
        Call<List<Paises>> caller = ApiService.getApiService().quizPaises();
            ...
            public void onResponse(Call<List<Paises>> call, Response<List<Paises>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (paisesList != null) {
                        ...
                        Log.e("Quiz", "No hay Datos de paises");
                    }
                } else {
                    Log.e("Quiz", "Error en Api " + response.message());
                }
            }

            @Override
            public void onFailure(Call<List<Paises>> call, Throwable t) {
                Log.e("Quiz", "Fallo en llamada de API", t);
            }
        });
    }
    ...
    public void setearDatos(List<Paises> paises) {
        ...
        Picasso.get().load(paisActual.getBandera()).into(quizImg);
        ...
        if(tipoDato == 0){
            ...
            quizOpc1.setText(paises.get(options[0]).getCapital());
            quizOpc2.setText(paises.get(options[1]).getCapital());
            quizOpc3.setText(paises.get(options[2]).getCapital());
            quizOpc4.setText(paises.get(options[3]).getCapital());
        }
    }
